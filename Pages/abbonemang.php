...
require_once("Models/SubscriptionHelper.php");
...
$plans = $subscriptionHelper->GetAllSubscriptionPlans();
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/abbonemang">Abonnemang</a></li>
                        <?php
                        if($dbContext->getUsersDatabase()->getAuth()->isLoggedIn()){ ?>
...
<div class="card h-100">
    <!-- Product image-->
    <img class="card-img-top" src="https://placehold.co/600x400?text=<?php echo $prod->title; ?>" alt="..." />
    <!-- Product details-->
