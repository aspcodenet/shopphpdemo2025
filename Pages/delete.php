...
$id = $_GET['id'] ;
$verified = $_GET['verified']  ?? false; // Om verified inte finns så sätt den till false
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <a href="/admin/delete?id=<?php echo $product->id ?>&verified=true" class="btn btn-danger">Ja</a>
        <a href="/admin/products" class="btn btn-primary">Ångra</a>
